...
class VirtualLineFollower:
    def __init__(self):
        ...
        # Parameters
        self.distance_threshold = 0.2  # meters to consider waypoint reached
        self.linear_speed = 0.3         # m/s
        self.angular_speed_gain = 1.5   # proportional gain for rotation
    ...
    def control_loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Control laws
            linear = self.linear_speed if distance > self.distance_threshold else 0.0
